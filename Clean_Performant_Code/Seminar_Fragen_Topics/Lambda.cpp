...
namespace Lambdas {
    ...
    static void test_03()
    {
        ...
        bool flag = true;  // JavaScript:  Closure

        auto l = [&](int n1, int n2) -> bool {
            std::cout << "lambda " << n1 << " mit " << n2 << std::endl;
            return (flag) ? n1 < n2 : n1 > n2;
        };

        // Hülle für ein Lambda (genauer: Aufrufbares)
        std::function < bool (int, int)  > f = [&](int n1, int n2) -> bool {
            std::cout << "lambda " << n1 << " mit " << n2 << std::endl;
            return (flag) ? n1 < n2 : n1 > n2;
            };

        std::vector<std::function < bool(int, int)  >> functions;
    ...
    static void test_07() {
      ...
      //  auto variable = 1;
        ...
        auto lambda = [variable = (short) 1] () mutable {
